...
Function Connect2OP {
    ...
    $Exchange = "mail.contoso.com"
     $OPSession = New-PSSession -Name "OP" -ConfigurationName Microsoft.Exchange -ConnectionUri "http://$Exchange/PowerShell/" -Credential $credential -Authentication Kerberos
...
Function Connect2EXO {
    ...
    $EXOSession = New-PSSession -Name "EXO" -ConfigurationName Microsoft.Exchange -ConnectionUri "https://outlook.office365.com/powershell-liveid/" -Credential $credential -Authentication "Basic" -AllowRedirection 
